...
DEFAULT_KWARGS = {
    'comment': 'exp10_1: Evaluate deviation of ResNet (N=9)',
    'lr': 0.1,
    'wd': 0.0001,
    'mom': 0.9,
    'bs': 128,
...
# created 12 random numbers using google rand num generator
SEEDS = [
    257, 408, 464, 82, 306, 369,
    414, 443, 394, 444, 318, 343
]
